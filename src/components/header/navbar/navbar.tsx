...
export default function NavLinks() {
    ...
    return (
            <ul className="flex items-center bg-vibe-black-06 rounded-lg border-[3px] 2xl:border-4 py-2 2xl:py-2.5 pl-2 2xl:pl-2.5 pr-[30px] 2xl:pr-10 border-vibe-black-12 gap-4 2xl:gap-[30px]">
                {navLinks.map(link => (
